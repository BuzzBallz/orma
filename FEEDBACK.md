...
> transaction hashes, and the full 40-finding register is in [`FEEDBACK-APPENDIX.md`](FEEDBACK-APPENDIX.md).
>
...
| **Evidence** | 40 findings with transaction hashes: `FEEDBACK-APPENDIX.md` |
