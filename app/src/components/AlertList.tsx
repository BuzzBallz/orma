            ...
            return (
              <div
                ...
                style={{
                  ...
                  background: a.severity === 'critical' ? 'color-mix(in srgb, var(--bad) 12%, transparent)' : undefined,
                  padding: '8px 12px',
                }}
              >
                ...
                <span className="mono" style={{ fontSize: 'var(--t-xs)', color: `var(${tone})`, flex: '0 0 auto' }}>
                  {a.code}
                </span>
              </div>
            )
